...
export const dateTime = document.getElementById("date-time") as HTMLDivElement;
...
export const generateForm = (action: [string, string]) => {
    ...
    return `<form id="task-form" class="${action[0]}">
                    ...
                    <button class="add-task green-btn">${action[1]} Task</button> <!-- Button to submit form -->
...
export const generateTask = (task: commonConstants.taskType) => {
