...
// Type Casting
const anchorByClassCasted = document.querySelector(".link") as HTMLAnchorElement;
...
const invPayList: (Invoice | Payment)[] = [];
...
const invDocOne: HasFormatter = new Invoice("Company Ltd", "work on company website", 350); // Possible because format() method is defined in Invoice class
const payDocOne: HasFormatter = new Payment("Business Inc", "construction work", 3000); // Possible because format() method is defined in Payment class

const docList: HasFormatter[] = [];
