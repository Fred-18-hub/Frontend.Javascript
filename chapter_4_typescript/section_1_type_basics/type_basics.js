...
isStudent = true;
console.log(fullName, age, isStudent);
var calcCircArea = function (diameter) {
...
// Arrays
console.log("ARRAYS:");
var names = ["John", "Jane", "Doe"]; // string[]: will only accept strings
names.push("Smith");
// names.push(10); // Error
names.unshift("Cesar");
// names.unshift(true); // Error
console.log(names);
var collection = ["John", 25, false]; // (string | number | boolean)[]: will accept strings, numbers, and booleans
